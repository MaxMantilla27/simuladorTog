...
import { RegistroCcnaExamenDTO, RegistroCcnaExamenRespuestaDTO } from 'src/app/Models/ExamenDTO';
...
export class ExamenService {
  ...
  public Registrar(Json:RegistroCcnaExamenDTO):Observable<any>{
  ...
  public RegistrarRespuestaSeleccion(Json:RegistroCcnaExamenRespuestaDTO):Observable<any>{
  ...
  public ObtenerMejorExamenPorUsuario(Json:RegistroCcnaExamenDTO):Observable<any>{
