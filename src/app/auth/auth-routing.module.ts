...
const routes: Routes = [
  {
    path: '', component: AuthComponent  , canActivateChild:[AuthGuard] , children:
      [
        ...
        { path:'ModoExamen/ExamenRespuestaPregunta/:IdExamen/:IdNivel', component: ExamenRespuestaPreguntaComponent},
        { path:'ModoExamen/ExamenIntermedio/:IdExamen', component: ExamenIntermedioComponent},
        ...
        { path:'ModoEntrenamiento/EntrenamientoRespuestaPregunta/:IdExamen/:IdNivel', component: EntrenamientoRespuestaPreguntaComponent},
        ...
        { path:'ModoEstudio/EstudioRespuestaPregunta/:IdExamen/:IdNivel', component: EstudioRespuestaPreguntaComponent},
      ]
  }
];
